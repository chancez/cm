...
func (c *serverClient) Status(ctx context.Context, req *StatusRequest) (*StatusResponse, error) {
	var resp StatusResponse
	if err := c.client.Call(ctx, "cm.server.v1.Server", "Status", req, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
