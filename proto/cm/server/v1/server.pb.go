...
const file_cm_server_v1_server_proto_rawDesc = "" +
	"\n" +
	"\x19cm/server/v1/server.proto\x12\fcm.server.v1\"\xcf\x01\n" +
	"\rAttachRequest\x12(\n" +
...
func file_cm_server_v1_server_proto_init() {
	...
	file_cm_server_v1_server_proto_msgTypes[0].OneofWrappers = []any{
		(*AttachRequest_Open)(nil),
		(*AttachRequest_Input)(nil),
		(*AttachRequest_Resize)(nil),
		(*AttachRequest_Detach)(nil),
	}
	file_cm_server_v1_server_proto_msgTypes[1].OneofWrappers = []any{}
	file_cm_server_v1_server_proto_msgTypes[5].OneofWrappers = []any{
