...
session; `d` to detach; `t` for the full `cm tui` picker; `:` for any cm command; `?` for the rest. That is how you name or move the session you are looking at while nvim or an agent
